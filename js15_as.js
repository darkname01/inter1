    ...
    var v = function () {
        ...
        , l = function (n, r) {
            ...
            try {
                ...
                var G = 45e3;
                i.d_ca = 0, i.d_pn = 0, i.d_pt = 0, i.f_pv = 0, i.s_ta = "", i.a_va = [], i.s_ti = "", i.asi = 0, i.o_fa = 0, i.o_de = 0, i.o_BC = 0, i.o_fr = 0, i.p_ff = 0, i.n_a = "", i.n_f = 0, i.n_n = 0, i.o_n = 0;
                var x = 31536e6;
                ...
                var Q = function () {
                    ...
                    , en = function (n) {
                        d()
                            .writeln('<script type="text/javascript" language="JavaScript" src="' + n + '"></script>')
                    }
                    , rn = function (n) {
                    ...
                    , sn = function () {
                        ...
                        n.id = Dn();
                        var t = d()
                            .getElementById("histats_counter");
                ...
                var mn = function () {
                    ...
                    , Nn = function () {
                        return "histats_counter_" + mn() + "_" + k()
                    }
                    , Un = function () {
                ...
                var Bn = function (n) {
                    ...
                    , jn = function (n) {
                        return D(n) ? r.encodeURIComponent ? r.encodeURIComponent(n) : r.escape(n)
                            .split("@")
                            .join("%40") : ""
                    };
                i.ENCODE = jn;
                ...
                var xn = function (n, t, e) {
                        try {
                            if (i.o_BC) return "";
                            var r, o;
                            o = new s, o.setTime(o.getTime() + e), r = e > 0 ? "; expires=" + o.toGMTString() : "; expires=Thu, 01-Jan-1970 00:00:01 GMT", d()
                                .cookie = n + "=" + t + r + "; path=/"
                        } catch (a) {
                            v(this, a)
                        }
                ...
                i.SC = xn, i.framed_page = function () {
                    i.o_fr = 1
                }, i.start = function (n, t, e, r, o, a, c) {
                    gn(t), i.i_dom = e, L(r), i.i_w = o, i.i_h = a, i.s_sc2 = c, (i.s_sc2.length > 8 || i.s_sc2.length < 1) && (i.s_sc2 = "")
                }, i.init = function () {
                    if (!i.o_i) {
                        ++i.o_i;
                        var n = new r.Date;
                        i.o_n = n.getTime(), i.n_a = a.appName, ("Opera" === i.n_a || a.userAgent.indexOf("Firefox") >= 0) && (i.n_f = 1), i.s_u = d()
                            .URL ? d()
                            .URL : d()
                            .location, i.s_u = Gn(i.s_u)
                            .substr(0, 500), N = d()
                            .referrer + "", i.s_ti = d()
                            .title, i.s_ti = Gn(i.s_ti)
                            .substr(0, 500);
                        var t = -1;
                        try {
                            i.d_s = c.width, i.o_fr && r.top != r.self && (N = "" + r.top.document.referrer), i.s_l = a["language"] || a.browserLanguage || "", "lt" == i.s_l.substr(0, 2) && (i.s_l = "lT"), "gt" == i.s_l.substr(0, 2) && (i.s_l = "gT"), i.s_l.length < 1 && (i.s_l = "0"), t = N.indexOf("//" + d()
                                .location.host)
                        } catch (e) {
                            i.s_l = "0", N = "1000", i.d_s = "0"
                        }
                        if (i.d_s = g(i.d_s), N = N.substr(0, 500), j = g(Bn("HstCla")), i.d_fa = g(Bn("HstCfa")), g(Bn("NoHits") > 0) && hn(), i.d_fa < 1 && (i.d_fa = i.o_n, kn("HstCfa", i.d_fa)), i.d_nv = 1, kn("HstCla", i.o_n), i.c_on = g(Bn("HstCla")), i.c_on > 0) {
                            j > 0 && (F = parseInt(i.o_n - j)), i.d_fa > 0 && (i.d_tf = parseInt(i.o_n - i.d_fa)), i.d_pn = g(Bn("HstPn")), i.d_pt = g(Bn("HstPt")), i.d_cv = g(Bn("HstCnv")), i.d_cs = g(Bn("HstCns")), i.d_mu = g(Bn("HstCmu")), i.d_pn++, i.d_pt++;
                            var o = 1e3
                                , s = 3600 * o
                                , u = 24 * s * 30.4
                                , _ = 600 * o
                                , f = 45 * o;
                            parseInt(i.o_n - i.d_mu) >= u && (kn("HstCmu", i.o_n), i.d_mu = 0), i.d_mu++, j < 1 || F >= u ? (i.d_pn = 1, i.d_cv = 1, i.d_pt = 1, i.d_cs = 1) : F > 0 && (F < s ? i.d_nv = 0 : (i.d_pn = 1, i.d_cv++), F > _ && i.d_cs++), i.d_cv < 1 && (i.d_cv = 1), 1 == i.d_nv && r.setTimeout(function () {
                                i.track_event("b")
                            }, f), kn("HstPn", i.d_pn), kn("HstPt", i.d_pt), kn("HstCnv", i.d_cv), kn("HstCns", i.d_cs)
                        }
                        D(N) && 1 == i.d_nv && t < 1 ? kn("c_ref_", jn(N)) : (D(Fn(An("c_ref_" + mn()))) && (N = Fn(An("c_ref_" + mn()))), D(N) || (N = "1000")), i.d_op = An("c_pd_" + mn()), y(i.d_op) || (i.d_op = 0), i.s_pd > 0 && kn("c_pd_", i.s_pd)
                    }
                };
                var Mn = function () {
                        try {
                    ...
                    , zn = function () {
                        i.init(), U = "" + (mn() + "") + ("&@f" + i.ver) + ("&@g" + i.d_nv) + ("&@h" + i.d_pn) + ("&@i" + i.d_cv) + ("&@j" + i.c_on) + ("&@k" + F) + ("&@l" + i.d_pt) + ("&@m" + jn(i.s_ti)) + ("&@n" + i.imp_v()) + ("&@o" + jn(N)) + ("&@q" + i.s_pd) + ("&@r" + i.d_op) + ("&@s" + k()) + ("&@t" + jn(i.s_l)) + ("&@u" + i.d_s) + ("&@b1:" + H()) + ("&@b3:" + qn()) + ("&@b4:" + jn("undefined" != typeof e ? e : "err")) + ("&@b5:" + Mn()) + ("&@a" + jn(_)) + ("&@v" + jn(i.s_u))
                    };
                i.add_v = function (n, t) {
                    D(n) && D(t) && ("tags" == n && (t = t.split(";")
                        .join(",")), i.a_va[g(i.a_va.length)] = jn(n) + "=" + jn(t))
                }, i.imp_v = function () {
                    var n = "0";
                ...
                i.load_JScall = Wn, i.load_GIFimg = O, i.load_GIFicon = O, i.load_gifImgOrTopImg = i.load_GIFimg, i.track_hits = function () {
                    ln() || (zn(), z() ? (B = "i/" + mn() + ".gif?", i.load_gifImgOrTopImg()) : P() ? (B = k() + ".gif?", i.load_GIFicon()) : M() || J() ? (Vn("1"), B = "0.php?", Wn(), _t()) : (B = mn() + ".php?", Wn()))
                };
                var Yn = function () {};
                i.track_event = function (n) {
                    i.d_ca > 100 || (i.d_ca++, U = "" + (mn() + "") + ("&@A" + n + "&@R" + f.ceil(1e5 * f.random())), B = "e.php?", K(), Wn())
                };
                var $n = function (n) {
                        Vn(n), _t()
                    }
                ...
                var Vn = function (n) {
                    ...
                    , rt = function (n) {
                        return Q() + Z() + "/counters/cc_" + n + ".js"
                    }
                    , it = function (n) {
                        i.s_asc2 = Qn(n);
                        var t = Xn();
                        i.s_sc1 = Zn(t, i.s_asc2), et(nt(t, i.s_asc2))
                    };
                i.sc1 = it, r._HST_cntval || (r._HST_cntval = "");
                var ot = {
                    ...
                    , ct = function () {
                        ...
                        dn(n, function () {
                            var n = r[tt(k())]
                                , t = En();
                            t && (ot.counterObjInstance = n(at(), r), null != ot.counterObjInstance && ot.counterObjInstance.start())
                        })
                    }
                    , st = function (n) {
                        return n > 0 && n < 400
                    ...
                    try {
                        ...
                        if ("undefined" != typeof n && "function" == typeof n.push)
                            for (var t in n) {
                                ...
                                e = r[n[t][0]];
                                var o = n[t][0].split(".");
                                "Histats" == o[0], 2 == o.length && (e = i[o[1]]), "function" == typeof e && e.apply(i, (n[t][1] + "")
                                    .split(","))
                            }
                    } catch (a) {
                        v(a)
